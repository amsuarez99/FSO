  ...
  const handlers = {
    ...
    addPerson: (event) => {
      ...
      const addNewPerson = async () => {
        ...
        try {
          const returnedPerson = phonebookService.create(newPerson);
          ...
          showNotification({
            text: `Information of ${newPerson.name} is already in the server`,
            status: "error",
          });
        }
      };
      ...
      const updateExistingPerson = async () => {
        ...
        try {
          const returnedPerson = phonebookService.update(
            updatedPerson.id,
            updatedPerson
          );
